package com.example.circledicator;
...
public class circledicator  extends LinearLayout {
    ...
    public circledicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public circledicator(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public circledicator(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
