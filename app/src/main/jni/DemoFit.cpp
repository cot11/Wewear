...
Java_com_example_cot11_wewear_ASMFit_nativeReadAAMModel
...
JNIEXPORT jboolean JNICALL Java_com_example_cot11_wewear_ASMFit_nativeLoadAvatar
...
Java_com_example_cot11_wewear_ASMFit_nativeReadModel
(JNIEnv * jenv, jclass, jstring jFileName)
{
...
JNIEXPORT jboolean JNICALL Java_com_example_cot11_wewear_ASMFit_nativeInitCascadeDetector
(JNIEnv * jenv, jclass, jstring jFileName)
{
...
JNIEXPORT jboolean JNICALL Java_com_example_cot11_wewear_ASMFit_nativeInitFastCascadeDetector
(JNIEnv * jenv, jclass, jstring jFileName)
{
    const char* cascade_name = jenv->GetStringUTFChars(jFileName, NULL);
...
JNIEXPORT void JNICALL Java_com_example_cot11_wewear_ASMFit_nativeDestroyCascadeDetector
(JNIEnv * jenv, jclass)
{
...
JNIEXPORT void JNICALL Java_com_example_cot11_wewear_ASMFit_nativeDestroyFastCascadeDetector
(JNIEnv * jenv, jclass)
{
...
JNIEXPORT jboolean JNICALL Java_com_example_cot11_wewear_ASMFit_nativeFastDetectAll
...
JNIEXPORT jboolean JNICALL Java_com_example_cot11_wewear_ASMFit_nativeDetectAll
(JNIEnv * jenv, jclass, jlong imageGray, jlong faces)
{
	Mat image = *((Mat*)imageGray);
	BEGINT();
...
JNIEXPORT void JNICALL Java_com_example_cot11_wewear_ASMFit_nativeInitShape(JNIEnv * jenv, jclass, jlong faces)
{
...
JNIEXPORT jboolean JNICALL Java_com_example_cot11_wewear_ASMFit_nativeDetectOne
...
JNIEXPORT void JNICALL Java_com_example_cot11_wewear_ASMFit_nativeFitting
...
JNIEXPORT jboolean JNICALL Java_com_example_cot11_wewear_ASMFit_nativeVideoFitting
...
JNIEXPORT void JNICALL Java_com_example_cot11_wewear_ASMFit_nativeDrawAvatar
